...
from . import Arank_cmd, get_string, HNDLR, async_searcher


@Arank_cmd(pattern="joke$")
async def _(ult):
    await ult.eor(get_joke())


@Arank_cmd(pattern="url ?(.*)")
async def _(event):
